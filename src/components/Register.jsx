...
export class Register extends React.Component {
    ...
    async register(e) {
        ...
        try {
            const { token } = await fetchData(API_BASE_URL + 'api/auth/register', 'POST', this.state.form)
    ...
    handleRepeatPasswordChange(e) {
        this.setState({ form: { ...this.state.form, repeatPassword: e.target.value } })
    }
    ...
    handlePhoneNumberCheckboxChange(e) {
        this.setState({ form: { ...this.state.form, isSmsAllowed: e.target.checked } })
    }
    ...
    render() {
        return (
            <form id="Login" onSubmit={(e) => this.register(e)} autoComplete="on">
                <fieldset>
                    <TextField id="outlined-basic" label="Login" type="email" variant="outlined" onChange={(e) => this.handleEmailChange(e)} noValidate required/>
                    <TextField id="outlined-basic" label="Password" type="password" variant="outlined" onChange={(e) => this.handlePasswordChange(e)} noValidate required/>
                    <TextField id="outlined-basic" label="Repeat Password" type="password" variant="outlined" onChange={(e) => this.handleRepeatPasswordChange(e)} noValidate required/>
                </fieldset>
                <fieldset>
                    <TextField id="outlined-basic" label="First Name" variant="outlined" onChange={(e) => this.handleFirstNameChange(e)} noValidate required/>
                    <TextField id="outlined-basic" label="Last Name" variant="outlined" onChange={(e) => this.handleLastNameChange(e)} noValidate required/>
                    <FormControl>
                ...
                <fieldset>
                    <TextField id="outlined-basic" type="tel" label="Phone Number" variant="outlined" onChange={(e) => this.handlePhoneNumberChange(e)} noValidate/>
                    <FormControlLabel
                        control={
                            <Checkbox 
